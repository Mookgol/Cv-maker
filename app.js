...
function softSkill(){
    let addSoftSkill = document.getElementById('addSkill');
    let softSkillHide = document.getElementById('skill_hide');
    if(soft_skill_count < 5) {
        soft_skill_count++;
        var field = `
            <div class="mb-3">
                <label class="form-label">soft_Skillset Name</label>
                <input type="text" class="form-control" name="soft_skill${soft_skill_count}" required>
                <select class="form-select mt-2" name="soft_skill_level${soft_skill_count}" required>
                    <option value="">Select stars based upon your skill level</option>
                    <option value="1">1 - Novice</option>
                    <option value="2">2 - Advanced Beginner</option>
                    <option value="3">3 - Competent</option>
        ...
        var htmlObject = document.createElement('div');
        htmlObject.innerHTML = field;
        addSoftSkill.appendChild(htmlObject);
    }
    if(soft_skill_count == 5) {
