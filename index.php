...
<!--            </div>-->
            <div class="border border-dark p-3 mb-3">    
                ...
                <label class="form-label">Age</label>
                    <input type="Age" class="form-control" id="Age" name="text" required>

                <label class="form-label">Sex</label>
                <input type="Sex" class="form-control" id="Sex" name="text" required>

                <label class="form-label">Gender</label>
                <input type="Gender" class="form-control" id="Gender" name="text" required>
...
<!--                <div class="border border-dark p-3 mb-3">-->
                    <labelaz`<saz></saz>>Summary career ambitions, your development goals, the impact you want to make</labelaz>
