...
<!--            <div class="border border-dark p-3 mb-3">    -->
                ...
                <div class="mb-3">
                    <label class="form-label">Location (Area and Province)</label>
                    <label>
            ...
            <label for="Age"></label><input type="number" class="form-control" id="Age" name="age" required>


                <label class="form-label">Gender</label>
            <label for="Gender"></label><input type="text" class="form-control" id="Gender" name="gender" required>

                <div class="mb-3">
                    <label class="form-label">Phone number</label>
                    <label for="phone"></label><input type="tel" class="form-control" id="phone" name="phone" placeholder="0300-1234567" pattern="[0-9]{4}-[0-9]{7}" required>
                </div>
...
<!--                <div class="border border-dark p-3 mb-3">-->
                    <label>Summary career ambitions, your development goals, the impact you want to make</label>
